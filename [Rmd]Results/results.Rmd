...
$t$(1, `r anovaTabAll_e1$numOfTrial$post[2,]$df`) = `r round(anovaTabAll_e1$numOfTrial$post[2,]$t,3)`, $p$ = `r round(anovaTabAll_e1$numOfTrial$post[2,]$p.value, 3)`, 
$t$(1, `r anovaTabAll_e1$numOfTrial$post[1,]$df`) = `r round(anovaTabAll_e1$numOfTrial$post[1,]$t,3)`, $p$ = `r round(anovaTabAll_e1$numOfTrial$post[1,]$p.value, 3)`) 
...
($t$(1, `r numOfsub-1`) = `r round(anovaTabAll_e1$BP_table$post[1,]$t,3)`, $p$ = `r round(anovaTabAll_e1$BP_table$post[1,]$p.value,3)`, 
Cohen’s  $d_z$ = `r anovaTabAll_e1$BP_table$cohen_d0`, $BF_{10}$ =  `r anovaTabAll_e1$BP_table$bayesF_d0`; 
$t$(1, `r numOfsub-1`) = `r round(anovaTabAll_e1$BP_table$post[2,]$t,3)`, $p$ =  `r round(anovaTabAll_e1$BP_table$post[2,]$p.value,3)`, 
...
($t$(1, `r numOfSub_e2-1`) = `r round(anovaTabAll_e2$BP_table$tVal[1],3)`, $p$ = `r round(anovaTabAll_e2$BP_table$pVal[1],3)`, Cohen’s  $d_z$ = `r anovaTabAll_e2$BP_table$cohend`, $BF_{10}$ =  `r anovaTabAll_e2$BP_table$bf`).
