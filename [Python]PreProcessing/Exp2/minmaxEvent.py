...
# tmp_rejectNum2 =[]
# tmp_rejectNum2 = np.argwhere(rt > 5).reshape(-1)
...
# y = np.array(events['dilation'])
# plt.plot(np.arange(9000),y[:numOfSub,:].mean(axis=0),'k-',linewidth=1,alpha=0.5)
# plt.plot(np.arange(9000),y[numOfSub:,:].mean(axis=0),'r-',linewidth=1,alpha=0.5)
